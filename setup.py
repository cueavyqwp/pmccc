...
if os.path.exists( "build" ) :
    rmtree( "build" )
if os.path.exists( "pmcll.egg-info" ) :
    rmtree( "pmcll.egg-info" )
if os.path.exists( "dist" ) :
    rmtree( "dist" )
if os.path.exists( os.path.join( "pmcll" , "__pycache__" ) ) :
    rmtree( os.path.join( "pmcll" , "__pycache__" ) )
...
setuptools.setup(
    ...
    url = "https://github.com/cueavy/pmcll" ,
